...
#define ccERR_CANT_CREATE_XMLADAPTER 'Cannot create an XMLAdapter object.'
#define ccERR_NO_FILENAME_SPECIFIED  'No file name was specified.'
#define ccERR_CANT_LOAD_XMLFILE      'Unable to load XML document <Insert1>.'
...
#define ccMSG_VALIDATE_AFTER_CONVERT 'Would you also like to validate the objects in the meta data (recommended)?'
